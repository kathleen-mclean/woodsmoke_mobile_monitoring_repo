  ...
  sidebarLayout(
    ...
    sidebarPanel(
      ...
      conditionalPanel(condition = "input.tabPanels == 2",
                       ...
                       radioButtons("mapopacity",
                                    "Choose transparency of the Z score layer:",
                                    choiceValues = c(0.7, 0.8, 0.9, 1.0),
                                    choiceNames = c("30%", "20%", "10%", "0%"),
                                    selected = 0.9),
